...
public class StandEnergyGUI extends AbstractGui {
    ...
    public void renderEnergyBar(MatrixStack stack) {
        ...
        Stand.getLazyOptional(player).ifPresent(stand -> {
            if(stand.getStandOn()) {
                ...
                if (i > 0) {
                    ...
                    this.blit(stack, x - 91, l, 0, 64, 182, 5);
                    if (k > 0) {
                        this.blit(stack, x - 91, l, 0, 69, k, 5);
                    }
                }
                ...
                mc.ingameGUI.getFontRenderer().drawString(stack, s, (float) (i1 + 1), (float) j1, 0);
                mc.ingameGUI.getFontRenderer().drawString(stack, s, (float) (i1 - 1), (float) j1, 0);
                mc.ingameGUI.getFontRenderer().drawString(stack, s, (float) i1, (float) (j1 + 1), 0);
                mc.ingameGUI.getFontRenderer().drawString(stack, s, (float) i1, (float) (j1 - 1), 0);
                mc.ingameGUI.getFontRenderer().drawString(stack, s, (float) i1, (float) j1, 15823613); //8453920
                ...
                if (Util.StandID.MOMENTUM_METER_STANDS.contains(stand.getStandID())) {
                    ...
                    mc.ingameGUI.getFontRenderer().drawString(stack, s, (float) i1, (float) (j1 + 1), 0);
                    mc.ingameGUI.getFontRenderer().drawString(stack, s, (float) i1, (float) (j1 - 1), 0);
                    mc.ingameGUI.getFontRenderer().drawString(stack, s, (float) i1, (float) j1, stand.getMomentum() > 50.0 ? 7464704 : 16738665); //8453920
                }
