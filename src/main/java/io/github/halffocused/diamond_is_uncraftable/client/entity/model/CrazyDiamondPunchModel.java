...
public class CrazyDiamondPunchModel extends AbstractStandAttackModel<CrazyDiamondPunchEntity> {
    ...
    public CrazyDiamondPunchModel() {
        ...
        Punch.setTextureOffset(0, 0).addBox(-2.0F, -24.0F, -6.0F, 4.0F, 4.0F, 12.0F, 0.0F, false);
        ...
        elbowPad1.setTextureOffset(30, 25).addBox(1.5F, -1.5F, -21.9125F, 1.0F, 3.0F, 4.0F, 0.0F, false);
        elbowPad1.setTextureOffset(53, 16).addBox(-2.5F, -0.5F, -22.1875F, 1.0F, 1.0F, 4.0F, 0.0F, false);
        elbowPad1.setTextureOffset(50, 28).addBox(-2.5F, -0.5F, -22.1625F, 5.0F, 1.0F, 1.0F, 0.0F, false);
        elbowPad1.setTextureOffset(49, 29).addBox(-2.5F, -0.5F, -18.5375F, 5.0F, 1.0F, 1.0F, 0.0F, false);
    }
