...
public class AerosmithModel extends EntityModel<AerosmithEntity> {
    ...
    @Override
    public void setRotationAngles(AerosmithEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    }
    ...
    @Override
    public void setLivingAnimations(AerosmithEntity p_212843_1_, float p_212843_2_, float p_212843_3_, float p_212843_4_) {
