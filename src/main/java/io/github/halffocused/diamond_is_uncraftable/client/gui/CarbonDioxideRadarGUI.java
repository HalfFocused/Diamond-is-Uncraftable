    ...
    public void renderRadar() {
        ...
        Stand.getLazyOptional(player).ifPresent(props -> {
            if (props.getStandID() == Util.StandID.AEROSMITH && props.getStandOn()) {
                ...
                Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation(DiamondIsUncraftable.MOD_ID, "textures/gui/aerosmith_radar.png"));
                    ...
                    mc.world.getAllEntities().forEach(entity -> {
                        if (Util.Predicates.BREATHS.test(entity) && entity != player && entity != aerosmith && entity.getDistance(aerosmith) < 16) {
                            ...
                            if (aerosmith != null) {
                                ...
                                Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation(DiamondIsUncraftable.MOD_ID, "textures/gui/aerosmith_target.png"));
                                GuiUtils.drawTexturedModalRect(0, 0, 0, 0, 256, 256, 0);
