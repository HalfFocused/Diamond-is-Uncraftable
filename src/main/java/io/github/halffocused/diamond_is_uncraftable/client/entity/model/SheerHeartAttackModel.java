...
public class SheerHeartAttackModel extends AbstractStandAttackModel<SheerHeartAttackEntity> {
    ...
    @Override
    public void setRotationAngles(SheerHeartAttackEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    }
