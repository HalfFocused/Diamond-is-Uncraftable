...
public class DesertStructure extends Structure<NoFeatureConfig> {
    ...
    public String getStructureName() {
        return DiamondIsUncraftable.STRUCTURE.toString();
    }
    ...
    public static class Start extends StructureStart {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn) {
            NoFeatureConfig nofeatureconfig = generator.getStructureConfig(biomeIn, DiamondIsUncraftable.DESERT_STRUCTURE);
