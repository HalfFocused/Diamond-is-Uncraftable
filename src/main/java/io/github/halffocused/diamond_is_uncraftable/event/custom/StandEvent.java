package io.github.halffocused.diamond_is_uncraftable.event.custom;
...
public class StandEvent extends PlayerEvent {
    ...
    /**
     * Fired when {@link io.github.halffocused.diamond_is_uncraftable.capability.Stand} standOn is set to false.
